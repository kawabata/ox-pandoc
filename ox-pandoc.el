...
(defcustom org-pandoc-menu-entry
  '(
    ...
    ;;(?d "as dzslides." org-pandoc-export-to-dzslides)
    (?D "to dzslides." org-pandoc-export-as-dzslides)
    ...
    ;;(?h "as html." org-pandoc-export-to-html)
    ;;(?H "to html." org-pandoc-export-as-html)
    ...
    ;;(?M "to man." org-pandoc-export-as-man)
    ;;(?m "as markdown." org-pandoc-export-to-markdown)
    ;;(?M "to markdown." org-pandoc-export-as-markdown)
    (?m "as markdown_github." org-pandoc-export-to-markdown_github)
    (?M "to markdown_github." org-pandoc-export-as-markdown_github)
    ...
    ;;(?m "as mediawiki." org-pandoc-export-to-mediawiki)
    ;;(?M "to mediawiki." org-pandoc-export-as-mediawiki)
    ...
    ;;(?o "as opml." org-pandoc-export-to-opml)
    (?O "to opml." org-pandoc-export-as-opml)
    ;;(?o "as org." org-pandoc-export-to-org)
    ;;(?O "to org." org-pandoc-export-as-org)
    (?p "as plain." org-pandoc-export-to-plain)
    (?P "to plain." org-pandoc-export-as-plain)
    (?r "as revealjs." org-pandoc-export-to-revealjs)
    ;;(?R "to revealjs." org-pandoc-export-as-revealjs)
    ;;(?r "as rst." org-pandoc-export-to-rst)
    ;;(?R "to rst." org-pandoc-export-as-rst)
    ;;(?r "as rtf." org-pandoc-export-to-rtf)
    (?R "to rtf." org-pandoc-export-as-rtf)
    (?s "as s5." org-pandoc-export-to-s5)
    ;;(?S "to s5." org-pandoc-export-as-s5)
    ;;(?s "as slideous." org-pandoc-export-to-slideous)
    (?S "to slideous." org-pandoc-export-as-slideous)
    ;;(?s "as slidy." org-pandoc-export-to-slidy)
    ;;(?S "to slidy." org-pandoc-export-as-slidy)
    (?t "as texinfo." org-pandoc-export-to-texinfo)
    ;;(?T "to texinfo." org-pandoc-export-as-texinfo)
    ;;(?t "as textile." org-pandoc-export-to-textile)
    (?T "to textile." org-pandoc-export-as-textile)
    )
  "Pandoc menu-entry."
  :group 'org-export-pandoc
  :type 'list)
